...
void storeWeights(char *fileName, double **weights[], int* num_neurons)
{
    ...
    else
    {
        ...
        {        
            ...
            printf("\n");*/
                ...
                /************************TESTING***************************************/
        storeWeights("weights.txt", weights,num_neurons);
        storeWeights("weights_m_t.txt", weights_m_t,num_neurons);
        storeWeights("weights_v_t.txt", weights_v_t,num_neurons);
